 ...
 * @author Garen
 */
@FeignClient(value = "MICROSERVICECLOUD-CONFIG-DEPT-CLIENT", fallbackFactory = DeptClientService_ConfigFallbackFactory.class) // 服务名称 和 fallbackFactory工厂类
public interface DeptClientService_Config {
